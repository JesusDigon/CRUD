...
public class MiAlmacen
{
    ...
    private static void borrar(){ 
      ...
      System.out.println("Introduzca el c�digo del producto a borrar: ");
      int codigo=leerEntero();
      Producto p=almacen.buscarProducto(codigo);
      if(p == null) {
    	  System.out.println("El producto no se encuentra en almacen");
         ...
         if( op == 's' || op == 'S' ) {
    	  ...
    	  System.out.println("acci�n anulada");
      }
    ...
    private static void comprar(){     
       ...
       System.out.println("Introduzca el c�digo del producto a comprar: ");
       int codigo=leerEntero();
       Producto p=almacen.buscarProducto(codigo);
       System.out.println("�Cuantas unidades va a a�adir? : ");
       int cant=leerEntero();
    ...
    private static void crear(){
       ...
       System.out.println("Introduzca el nombre del producto que quiere a�adir: ");
